...
/**
 * Layout Class displaying specialized progress bar whose progress starts from
 * center,
 * 
 * @author Wonjun Kim
 * 
...
public class PullingProgressLayout extends LinearLayout {
	...
	private void initializeLayout(Context context) {
		...
		LayoutInflater.from(context).inflate(R.layout.pulling_progress_layout,
				this);
		...
		mPullingLeftBar.setProgressDrawable(res
				.getDrawable(R.drawable.progress_horizontal_holo_light));
		mPullingRightBar.setProgressDrawable(res
				.getDrawable(R.drawable.progress_horizontal_holo_light));
	 ...
	 * 
	 * @param percent
	 *            Positive integer value. max is 100.
	 */
