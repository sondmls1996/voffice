...
public class ViewCompat {
	...
	private static class Methods {
		...
		private static void initializeMethods() {
			...
			try {
				viewClazz = (Class<? extends View>) Class
			...
			try {
				setLayerTypeMethod = viewClazz.getMethod("setLayerType",
			...
			try {
				postOnAnimationMethod = viewClazz.getMethod("postOnAnimation",
						Runnable.class);
			} catch (NoSuchMethodException e) {
			}
			...
			try {
				setBackgroundMethod = viewClazz.getMethod("setBackground",
						Drawable.class);
			} catch (NoSuchMethodException e) {
			}
