...
public class ToolTipsManager {
	...
	private Map<Integer, View> mTipsMap = new HashMap<Integer, View>();
	...
	private TextView createTipView(ToolTip toolTip) {
		...
		tipView.setText(toolTip.getMessage() != null ? toolTip.getMessage()
				: toolTip.getSpannableMessage());
	...
	private void animateDismiss(final View view, final boolean byUser) {
		AnimationUtils.popout(view, mAnimationDuration,
