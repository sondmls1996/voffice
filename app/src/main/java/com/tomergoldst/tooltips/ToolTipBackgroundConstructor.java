...
class ToolTipBackgroundConstructor {
	...
	private static void setToolTipAboveBackground(View tipView, ToolTip toolTip) {
		...
		case ToolTip.ALIGN_CENTER:
			setTipBackground(tipView, R.drawable.tooltip_arrow_down,
					toolTip.getBackgroundColor());
			break;
		case ToolTip.ALIGN_LEFT:
			setTipBackground(tipView,
					!UiUtils.isRtl() ? R.drawable.tooltip_arrow_down_left
							: R.drawable.tooltip_arrow_down_right,
					toolTip.getBackgroundColor());
			break;
		case ToolTip.ALIGN_RIGHT:
			setTipBackground(tipView,
					!UiUtils.isRtl() ? R.drawable.tooltip_arrow_down_right
	...
	private static void setToolTipBelowBackground(View tipView, ToolTip toolTip) {
		...
		switch (toolTip.getAlign()) {
		case ToolTip.ALIGN_CENTER:
			setTipBackground(tipView, R.drawable.tooltip_arrow_up,
					toolTip.getBackgroundColor());
			break;
		case ToolTip.ALIGN_LEFT:
			setTipBackground(tipView,
					!UiUtils.isRtl() ? R.drawable.tooltip_arrow_up_left
							: R.drawable.tooltip_arrow_up_right,
					toolTip.getBackgroundColor());
			break;
		case ToolTip.ALIGN_RIGHT:
			setTipBackground(tipView,
					!UiUtils.isRtl() ? R.drawable.tooltip_arrow_up_right
	...
	private static void setToolTipLeftToBackground(View tipView, int color) {
		setTipBackground(tipView,
				!UiUtils.isRtl() ? R.drawable.tooltip_arrow_right
						: R.drawable.tooltip_arrow_left, color);
	}

	private static void setToolTipRightToBackground(View tipView, int color) {
		setTipBackground(tipView,
				!UiUtils.isRtl() ? R.drawable.tooltip_arrow_left
						: R.drawable.tooltip_arrow_right, color);
	}
	...
	private static void setTipBackground(View tipView, int drawableRes,
			int color) {
	...
	@SuppressWarnings("deprecation")
	private static Drawable getTintedDrawable(Context context, int drawableRes,
			int color) {
		Drawable drawable;
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
