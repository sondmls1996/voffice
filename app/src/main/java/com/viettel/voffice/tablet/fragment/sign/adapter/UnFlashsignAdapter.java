...
public class UnFlashsignAdapter extends RecyclerSwipeAdapter<UnFlashsignAdapter.SimpleViewHolder> {
...
//            });
    ...
    private ArrayList<UnFlashsignObj> mDataset;

    //protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);
    protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);
    public UnFlashsignAdapter(Context context, ArrayList<UnFlashsignObj> objects) {
        this.mContext = context;
        this.mDataset = objects;
    }

    @Override
    public UnFlashsignAdapter.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sign, parent, false);
        return new UnFlashsignAdapter.SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final UnFlashsignAdapter.SimpleViewHolder viewHolder, final int position) {
        UnFlashsignObj item = mDataset.get(position);
