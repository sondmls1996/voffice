...
public class RecycleAdapter extends RecyclerSwipeAdapter<RecycleAdapter.SimpleViewHolder> {
...
//            });
    ...
    protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);
    public RecycleAdapter(Context context, ArrayList<SignListObj> objects) {
