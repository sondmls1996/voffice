...
public class ListUnFlashsignAdapter extends ArrayAdapter<UnFlashsignObj> {
    Context ct;
    ArrayAdapter<UnFlashsignObj> array;

    public ListUnFlashsignAdapter(Context context, int resource, ArrayList<UnFlashsignObj> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View v = convertView;
        UnFlashsignObj pill = getItem(position);
        if(v==null){
