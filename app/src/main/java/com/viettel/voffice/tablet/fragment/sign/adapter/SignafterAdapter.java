...
public class SignafterAdapter extends RecyclerSwipeAdapter<SignafterAdapter.SimpleViewHolder> {
...
//            });
    ...
    private ArrayList<SignafterListObj> mDataset;

    //protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);
    protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);
    public SignafterAdapter(Context context, ArrayList<SignafterListObj> objects) {
        this.mContext = context;
        this.mDataset = objects;
    }

    @Override
    public SignafterAdapter.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sign, parent, false);
        return new SignafterAdapter.SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SignafterAdapter.SimpleViewHolder viewHolder, final int position) {
        SignafterListObj item = mDataset.get(position);
