...
public class ListSignedAdapter extends ArrayAdapter<SignedListObj> {
    Context ct;
    ArrayAdapter<SignedListObj> array;

    public ListSignedAdapter(Context context, int resource, ArrayList<SignedListObj> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View v = convertView;
        SignedListObj pill = getItem(position);
        if(v==null){
