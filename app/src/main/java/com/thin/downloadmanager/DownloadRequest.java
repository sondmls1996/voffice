...
public class DownloadRequest implements Comparable<DownloadRequest> {
	...
	private boolean deleteFileWhenDownFail = true;
	...
	public DownloadRequest setValue(byte[] value) {
		this.value = value;
		return this;
	}
	...
	public DownloadRequest setDownloadListener(
	...
	public int compareTo(DownloadRequest other) {
		...
		// ordering.
		return left == right ? this.mDownloadId - other.mDownloadId : right
				.ordinal() - left.ordinal();
	}

	public boolean isDeleteFileWhenDownFail() {
		return deleteFileWhenDownFail;
	}

	public void setDeleteFileWhenDownFair(boolean deleteFileWhenDownFair) {
		this.deleteFileWhenDownFail = deleteFileWhenDownFair;
	}
